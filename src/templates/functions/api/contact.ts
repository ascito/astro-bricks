 ...
 *  - `CONTACT_WEBHOOK_URL` (Secret) — URL n8n complète (ex: https://n8n.factory.cocorico.quest/webhook/contact-XXX)
 *  - `SITE_ORIGIN` (Variable) — origine du site (ex: https://saunaguide.fr)
 *
 * Avantages :
